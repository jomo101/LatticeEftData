...
All parametrizations for scattering amplitude, i.e. for the phaseshift $\delta$, are using effective range parameterization, with \
$$p\cot\delta = a + b \cdot p^2$$ \
where $p$ is the relative momentum of the two-nucleon system in the center of mass frame,
